              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive
                      ? "grayscale-0 drop-shadow-[0_0_8px_rgba(251,191,36,0.8)] scale-110"
                      : "grayscale opacity-40 group-hover:opacity-100 group-hover:grayscale-0 group-hover:drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]",
                  )}
                >
                  {item.emoji}
                </span>
